...
AudioInputI2S            i2s2;           //xy=56,45
AudioMixer4              mixer1;         //xy=221,214.99999237060547
AudioPlaySdRaw           playRaw1;       //xy=226.00000762939453,140.0000057220459
AudioAnalyzePeak         peak1;          //xy=229,90
AudioRecordQueue         queue1;         //xy=232,45
AudioOutputI2S           i2s1;           //xy=400.0000171661377,140.00000381469727
AudioConnection          patchCord1(i2s2, 0, queue1, 0);
AudioConnection          patchCord2(i2s2, 0, peak1, 0);
AudioConnection          patchCord3(i2s2, 0, mixer1, 0);
AudioConnection          patchCord4(playRaw1, 0, i2s1, 0);
AudioConnection          patchCord5(playRaw1, 0, i2s1, 1);
AudioControlSGTL5000     sgtl5000_1;     //xy=227.00000762939453,292.00001335144043
...
Bounce buttonStop =   Bounce(21, 8);  // 8 = 8 ms debounce time
...
//  Serial.println("stopMonitoring");
//  if (mode == 2) mixer1.gain(0, 0);
  mode = 0;
}
