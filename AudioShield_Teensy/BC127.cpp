...
enum serialMsg parseSerialIn(String input) {
    if(debug) MONPORT.printf("<-BC127: %s\n", input.c_str());
    ...
    switch(nb_params) {
        ...
        // READY
        case 0: {
            if(notif.equalsIgnoreCase("INQU_OK")) return BCNOT_INQ_DONE;
            else if(notif.equalsIgnoreCase("READY")) BC127_ready = true;
            break;
        }
        ...
        // AVRCP_PAUSE [link_ID]
        case 1: {
            if(notif.equalsIgnoreCase("AVRCP_PLAY")) return msgAvrcpPlay();
            else if(notif.equalsIgnoreCase("AVRCP_PAUSE")) return msgAvrcpPause();
            break;
        }
        ...
        // NAME [addr] {"name" || name}
        case 2: {
            if(notif.equalsIgnoreCase("ABS_VOL")) return msgAbsVol(param1, param2);
            else if(notif.equalsIgnoreCase("LINK_LOSS")) return msgLinkLoss(param1, param2);
            else if(notif.equalsIgnoreCase("NAME")) return msgName1(param1, param2);
            break;
        }
        ...
        case 3: {
            if(notif.equalsIgnoreCase("CLOSE_OK")) return msgCloseOk(param1, param2, param3);
            else if(notif.equalsIgnoreCase("NAME")) return msgName2(param1, param2, param3);
            else if(notif.equalsIgnoreCase("OPEN_OK")) return msgOpenOk(param1, param2, param3);
            else if(notif.equalsIgnoreCase("RECV")) return msgRecv1(param1, param2, param3);
            break;
        }
        ...
        case 4: {
            if(notif.equalsIgnoreCase("INQUIRY")) return msgInquiry1(param1, param2, param3, param4);
            else if(notif.equalsIgnoreCase("NAME")) return msgName3(param1, param2, param3, param4);
            else if(notif.equalsIgnoreCase("STATE")) return msgState(param1, param2, param3, param4);
            else if(notif.equalsIgnoreCase("RECV")) return msgRecv2(param1, param2, param3, param4);
            break;
        }
        ...
        case 5: {
            if(notif.equalsIgnoreCase("INQUIRY")) return msgInquiry2(param1, param2, param3, param4, param5);
            else if(notif.equalsIgnoreCase("LINK")) return msgLink1(param1, param2, param3, param4, param5);
            else if(notif.equalsIgnoreCase("NAME")) return msgName4(param1, param2, param3, param4, param5);
            else if(notif.equalsIgnoreCase("RECV")) return msgRecv3(param1, param2, param3, param4, param5);
            break;
        }
        ...
        case 6: {
            if(notif.equalsIgnoreCase("INQUIRY")) return msgInquiry3(param1, param2, param3, param4, param5, param6);
            else if(notif.equalsIgnoreCase("RECV")) return msgRecv4(param1, param2, param3, param4, param5, param6);
            else if(notif.equalsIgnoreCase("LINK")) return msgLink2(param1, param2, param3, param4, param5, param6);
            break;
        }
        ...
        case 7: {
            if(notif.equalsIgnoreCase("INQUIRY")) return msgInquiry4(param1, param2, param3, param4, param5, param6, param7);
            else if(notif.equalsIgnoreCase("LINK")) return msgLink3(param1, param2, param3, param4, param5, param6, param7);
            break;
        }
        ...
        case 8: {
            if(notif.equalsIgnoreCase("INQUIRY")) return msgInquiry5(param1, param2, param3, param4, param5, param6, param7, param8);
            else if(notif.equalsIgnoreCase("LINK")) return msgLink4(param1, param2, param3, param4, param5, param6, param7, param8);
            break;
        }

        // LINK [link_ID] (state) (profile) (btaddr) (info1) (info2) (info3) (info4) (info5)
        case 9: {
            if(notif.equalsIgnoreCase("LINK")) return msgLink5(param1, param2, param3, param4, param5, param6, param7, param8, param9);
            break;
        }
...
void populateDevlist(String addr, String name, String caps, unsigned int stren) {
    ...
    // if(debug) MONPORT.println("Info:    Device list:");
    // for(unsigned int i = 0; i < found_dev; i++) {
    // if(debug) MONPORT.print(i); if(debug) MONPORT.print(": ");
    // if(debug) MONPORT.print(dev_list[i].address); if(debug) MONPORT.print(", ");
    // if(debug) MONPORT.print(dev_list[i].capabilities); if(debug) MONPORT.print(", ");
    // if(debug) MONPORT.println(dev_list[i].strength);
    // }
}
...
bool searchDevlist(String name) {
    for(int i = 0; i < DEVLIST_MAXLEN; i++) {
        if(dev_list[i].name.equalsIgnoreCase(name)) {
            if(debug) MONPORT.println("Info:    Device found in list!");
            BT_peer_address = dev_list[i].address;
            return true;
        }
    }
    if(debug) MONPORT.println("Info:    Nothing found in list");
    return false;
}
...
unsigned int countParams(String input) {
    ...
    // if(debug) MONPORT.printf("#params: %d\n", nb_params);
    return ret;
}
...
enum serialMsg msgOpenOk(String p1, String p2, String p3) {
    if(param2.equalsIgnoreCase("A2DP")) {
        ...
        if(debug) MONPORT.printf("Info:    A2DP connection opened. Conn ID: %d, peer address = %s\n",
        ...
        BT_peer_address = param3;
        if(debug) MONPORT.printf("Info:    AVRCP connection opened. Conn ID: %d, peer address (check) = %s\n", BT_id_avrcp, BT_peer_address.c_str());
        return BCCMD__NOTHING;
    }
    else if(param2.equalsIgnoreCase("BLE")) {
        BLE_conn_id = param1.toInt();
        // if(debug) MONPORT.printf("Info:    BLE connection opened. Conn ID: %d\n", BLE_conn_id);
...
enum serialMsg msgRecv1(String p1, String p2, String p3) {
    ...
    if(param1.toInt() == BLE_conn_id) {
        if(param3.equalsIgnoreCase("inq")) {
            ...
            if(debug) MONPORT.println("Info:    Receiving latlong without values");
        }
    }
    ...
    if(param1.toInt() == BLE_conn_id) {
        if(p3.equalsIgnoreCase("conn")) {
            ...
            if(rec_time > MIN_TIME_DEC) {
                ...
                if(debug) MONPORT.printf("Info:    Timestamp received: %ld\n", rec_time);
            }
            else {
                if(debug) MONPORT.println("Error: Received time not correct!");
            }
        }
        else if(p3.equalsIgnoreCase("rec")) {
            if(p4.equalsIgnoreCase("start")) return BCCMD_REC_START;
            else if(p4.equalsIgnoreCase("stop")) return BCCMD_REC_STOP;
            else if(p4.equalsIgnoreCase("?")) return BCNOT_REC_STATE;
        }
        else if(p3.equalsIgnoreCase("rec_next")) {
            if(p4.equalsIgnoreCase("?")) return BCNOT_REC_NEXT;
            else {
                if(debug) MONPORT.println("Error: BLE rec_next command not listed");
            }
        }
        else if(p3.equalsIgnoreCase("rec_nb")) {
            if(p4.equalsIgnoreCase("?")) return BCNOT_REC_NB;
            else {
                if(debug) MONPORT.println("Error: BLE rec_nb command not listed");
            }
        }
        else if(p3.equalsIgnoreCase("rec_ts")) {
            if(p4.equalsIgnoreCase("?")) return BCNOT_REC_TS;
            else {
                if(debug) MONPORT.println("Error: BLE rec_ts command not listed");
            }
        }
        else if(p3.equalsIgnoreCase("mon")) {
            if(p4.equalsIgnoreCase("start")) working_state.mon_state = MONSTATE_REQ_ON;
            else if(p4.equalsIgnoreCase("stop")) working_state.mon_state = MONSTATE_REQ_OFF;
            else if(p4.equalsIgnoreCase("?")) return BCNOT_MON_STATE;
        }
...
enum serialMsg msgLink1(String p1, String p2, String p3, String p4, String p5) {
    if(p3.equalsIgnoreCase("A2DP")) {
        BT_id_a2dp = p1.toInt();
        BT_peer_address = p4;
        if(debug) MONPORT.printf("Info:    A2DP address: %s, ID: %d\n", BT_peer_address.c_str(), BT_id_a2dp);
        working_state.bt_state = BTSTATE_CONNECTED;
        return BCCMD_BT_NAME;
    }
        ...
        BT_peer_address = p4;
        if(debug) MONPORT.printf("Info:    AVRCP address: %s, ID: %d\n", BT_peer_address.c_str(), BT_id_avrcp);
        working_state.bt_state = BTSTATE_CONNECTED;
    }
    return BCCMD__NOTHING;
}
...
enum serialMsg msgInquiry3(String p1, String p2, String p3, String p4, String p5, String p6) {
    ...
    String name;
    if(p2.substring(0,1).equalsIgnoreCase("\"")) {
        name = p2.substring(1) + "_" + p3 + "_" + p4.substring(0, (p4.length()-1));
    }
    else {
        name = p2 + "_" + p3 + "_" + p4;
    }
...
enum serialMsg msgInquiry4(String p1, String p2, String p3, String p4, String p5, String p6, String p7) {
    ...
    String name;
    if(p2.substring(0,1).equalsIgnoreCase("\"")) {
        name = p2.substring(1) + "_" + p3 + "_" + p4 + "_" + p5.substring(0, (p5.length()-1));
    }
    else {
...
enum serialMsg msgInquiry5(String p1, String p2, String p3, String p4, String p5, String p6, String p7, String p8) {
    ...
    String name;
    if(p2.substring(0,1).equalsIgnoreCase("\"")) {
        name = p2.substring(1) + "_" + p3 + "_" + p4 + "_" + p5 + "_" + p6.substring(0, (p6.length()-1));
    }
    else {
...
String cmdDevConnect(void) {
    if(searchDevlist(BT_peer_name)) {
        if(debug) MONPORT.printf("Info:    Opening BT connection @%s (%s)\n", BT_peer_address.c_str(), BT_peer_name.c_str());
